...
namespace Sakrus.Infrastructure.Migrations
{
    ...
    [Migration("20260804144103_SprintProprietariosEDocumentos")]
    partial class SprintProprietariosEDocumentos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sakrus.Core.Entities.ExumacaoRegistro", b =>
                {
                    ...
                    b.Property<TimeSpan?>("HorarioExecucao")
                        .HasColumnType("interval");
            ...
            modelBuilder.Entity("Sakrus.Core.Entities.Falecido", b =>
                {
                    ...
                    b.Property<string>("CodigoIndigente")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Sakrus.Core.Entities.JazigoProprietario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("HerdeiroPrevistId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("HerdeiroPrevistId");

                    b.HasIndex("UsuarioId");

                    b.HasIndex("JazigoId", "Ativo");
            ...
            modelBuilder.Entity("Sakrus.Core.Entities.JazigoProprietario", b =>
                {
                    b.HasOne("Sakrus.Core.Entities.Responsavel", "HerdeiroPrevisto")
                        .WithMany()
                        .HasForeignKey("HerdeiroPrevistId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Sakrus.Core.Entities.Responsavel", b =>
                {
                    ...
                    b.Navigation("JazigoProprietarios");
                });
